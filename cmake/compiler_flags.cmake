...
if(APPLE)
  if(WITH_STATIC_CRT)
    find_library (LIBCXX_A NAMES libc++.a)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -lc++abi ${LIBCXX_A}")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -lc++abi ${LIBCXX_A}")
