...
if(NOT (CMAKE_BUILD_TYPE STREQUAL ""))
    set(OPTIONS
            ${OPTIONS} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE})
endif()
...
ExternalProject_ADD(
  ...
  CONFIGURE_COMMAND 
    ...
    ${CMAKE_COMMAND} ${OPTIONS}  -DBUILD_SHARED_LIBS=ON -BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_SOURCE_DIR:PATH=<SOURCE_DIR>/runtime/Cpp <SOURCE_DIR>/runtime/Cpp
  LOG_CONFIGURE ON
  LOG_BUILD ON
)
