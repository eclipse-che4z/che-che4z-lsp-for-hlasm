...
const std::string ws2_path = is_windows() ? R"(c:\path\to\W S\TwoDrive)" : R"(/path/to/W S/TwoDrive)";
const std::string ws3_path = is_windows() ? R"(c:\path\to\W S\ThreeDrive)" : R"(/path/to/W S/ThreeDrive)";
const std::string ws4_path = is_windows() ? R"(c:\path\to\W S\FourDrive)" : R"(/path/to/W S/FourDrive)";
