...
hlasm_plugin::parser_library::semantics::machine_operand::machine_operand(std::function<std::string()> get_text) : substituable_operand(std::move(get_text)) {}

operand_type hlasm_plugin::parser_library::semantics::machine_operand::type() const { return operand_type::MACH; }

hlasm_plugin::parser_library::semantics::assembler_operand::assembler_operand(std::function<std::string()> get_text) : substituable_operand(std::move(get_text)) {}
...
hlasm_plugin::parser_library::semantics::ca_operand::ca_operand(seq_sym seqence_symbol, expr_ptr expression)
	: expression(std::move(expression)), seqence_symbol(std::move(seqence_symbol)), kind(ca_operand_kind::BRANCH_EXPR) {}

hlasm_plugin::parser_library::semantics::ca_operand::ca_operand(expr_ptr expression)
