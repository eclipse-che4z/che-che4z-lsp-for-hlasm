...
private:
    ...
    bool is_LCL_GBL(const processing::resolved_statement& statement, context::SET_t_enum& set_type, bool& global);
    bool is_SET(const processing::resolved_statement& statement, context::SET_t_enum& set_type);
};
