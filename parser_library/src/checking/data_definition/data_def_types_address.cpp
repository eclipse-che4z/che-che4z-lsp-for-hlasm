...
data_def_type_A_AD_Y::data_def_type_A_AD_Y(char type, char extension, alignment align, uint64_t implicit_length) :
	data_def_type(type, extension, no_check(), no_check(),
		n_a(), n_a(), nominal_value_type::EXPRESSIONS, align, implicit_length)
{
}

data_def_type_A::data_def_type_A() : data_def_type_A_AD_Y('A', '\0', fullword, 4) {}

bool check_A_AD_Y_length(const std::string & type, const data_definition_operand& op, const diagnostic_collector& add_diagnostic,
	int min_byte_abs, int max_byte_abs, int min_byte_sym, int max_byte_sym, int min_bit, int max_bit)
{
...
bool data_def_type_A::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
data_def_type_AD::data_def_type_AD() : data_def_type_A_AD_Y('A', 'D', doubleword, 8) {}

bool data_def_type_AD::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
data_def_type_Y::data_def_type_Y() : data_def_type_A_AD_Y('Y', '\0', halfword, 2) {}

bool data_def_type_Y::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
bool data_def_type_S::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
data_def_type_SY::data_def_type_SY() : data_def_type_S_SY('Y', 3) {}

bool data_def_type_SY::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
data_def_type_single_symbol::data_def_type_single_symbol(char type, char extension, modifier_spec length_bound, alignment align, uint64_t implicit_length) :
	data_def_type(type, extension, n_a(), length_bound,
		n_a(), n_a(), nominal_value_type::EXPRESSIONS, align, implicit_length) {}

bool hlasm_plugin::parser_library::checking::data_def_type_single_symbol::expects_single_symbol() const
{
	return true;
}

data_def_type_R::data_def_type_R() : data_def_type_single_symbol('R', '\0', modifier_bound{ 3,4 }, fullword, 4) {}

data_def_type_RD::data_def_type_RD() : data_def_type_single_symbol('R', 'D', no_check(), doubleword, 8) {}
...
data_def_type_V::data_def_type_V() : data_def_type_single_symbol('V', '\0', modifier_bound{ 3,4 }, fullword, 4) {}

data_def_type_VD::data_def_type_VD() : data_def_type_single_symbol('V', 'D', no_check(), doubleword, 8) {}
...
data_def_type_Q::data_def_type_Q() : data_def_type_single_symbol('Q', '\0', modifier_bound{ 1,4 }, fullword, 4) {}

data_def_type_QD::data_def_type_QD() : data_def_type_single_symbol('Q', 'D', modifier_bound{ 1,8 }, quadword, 8) {}

data_def_type_QY::data_def_type_QY() : data_def_type_single_symbol('Q', 'Y', modifier_bound{ 3,3 }, halfword, 3) {}


//***************************   types J, JD   *****************************//

data_def_type_J::data_def_type_J() : data_def_type_single_symbol('J', '\0', no_check(), fullword, 4) {}

bool data_def_type_J::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool) const
{
	if (op.length.present && op.length.value != 2 && op.length.value != 3 && op.length.value != 4 && op.length.value != 8)
	{
...
data_def_type_JD::data_def_type_JD() : data_def_type_single_symbol('J', 'D', no_check(), doubleword, 8) {}
