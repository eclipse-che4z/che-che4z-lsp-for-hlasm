...
data_def_type_E_D_L::data_def_type_E_D_L(char type, char extension, modifier_spec bit_length_spec,
	modifier_spec length_spec, modifier_spec scale_spec, alignment align, uint64_t implicit_length) :
	data_def_type(type, extension, bit_length_spec, length_spec,
		scale_spec, modifier_bound{ -85 , 75 }, nominal_value_type::STRING, align, implicit_length) {}
...
bool data_def_type_E_D_L::check(const data_definition_operand& op, const diagnostic_collector& add_diagnostic, bool check_nominal) const
{
	if (!check_nominal)
		return true;
...
data_def_type_EH::data_def_type_EH() :
	data_def_type_E_D_L('E', 'H', modifier_bound{ 12, 64 }, modifier_bound{ 1, 8 }, modifier_bound{ 0, 5 }, fullword, 4) {}
...
data_def_type_D::data_def_type_D() :
	data_def_type_E_D_L('D', '\0', modifier_bound{ 1, 64 }, modifier_bound{ 1, 8 }, modifier_bound{ 0, 13 }, doubleword, 8) {}

data_def_type_DH::data_def_type_DH() :
	data_def_type_E_D_L('D', 'H', modifier_bound{ 12, 64 }, modifier_bound{ 1, 8 }, modifier_bound{ 0, 13 }, doubleword, 8) {}
...
data_def_type_L::data_def_type_L() :
	data_def_type_E_D_L('L', '\0', modifier_bound{ 1, 128 }, modifier_bound{ 1, 16 }, modifier_bound{ 0, 27 }, doubleword, 16) {}

data_def_type_LH::data_def_type_LH() :
	data_def_type_E_D_L('L', 'H', modifier_bound{ 12, 128 }, modifier_bound{ 1, 16 }, modifier_bound{ 0, 27 }, doubleword, 16) {}

data_def_type_LQ::data_def_type_LQ() :
	data_def_type_E_D_L('L', 'Q', modifier_bound{ 12, 128 }, modifier_bound{ 1, 16 }, modifier_bound{ 0, 27 }, quadword, 16) {}
