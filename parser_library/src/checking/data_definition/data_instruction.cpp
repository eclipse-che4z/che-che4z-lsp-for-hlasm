...
dc::dc(const std::vector<label_types>& allowed_types, const std::string& name_of_instruction) : data(allowed_types, name_of_instruction) {}
...
ds_dxd::ds_dxd(const std::vector<label_types>& allowed_types, const std::string& name_of_instruction) :data(allowed_types, name_of_instruction) {};
