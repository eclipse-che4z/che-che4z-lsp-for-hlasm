...
{
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>(
        "*PROCESS", std::make_unique<process>(std::vector<label_types> { label_types::NO_LABEL }, "*PROCESS")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ACONTROL",
        std::make_unique<acontrol>(
            std::vector<label_types> { label_types::SEQUENCE_SYMBOL, label_types::OPTIONAL }, "ACONTROL")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ADATA",
        std::make_unique<adata>(
            std::vector<label_types> { label_types::SEQUENCE_SYMBOL, label_types::OPTIONAL }, "ADATA")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("AINSERT",
        std::make_unique<ainsert>(
            std::vector<label_types> { label_types::SEQUENCE_SYMBOL, label_types::OPTIONAL }, "AINSERT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ALIAS",
        std::make_unique<alias>(
            std::vector<label_types> { label_types::ORD_SYMBOL, label_types::VAR_SYMBOL }, "ALIAS")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("AMODE",
    ...
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CCW",
        std::make_unique<ccw<CCW_variant::CCW_CCW0>>(
            ...
            "CCW")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CCW0",
        std::make_unique<ccw<CCW_variant::CCW_CCW0>>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "CCW0")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CCW1",
        std::make_unique<ccw<CCW_variant::CCW1>>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "CCW1")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CEJECT",
        std::make_unique<expression_instruction>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "CEJECT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CNOP",
        std::make_unique<cnop>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "CNOP")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("COM",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "COM")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("COPY",
        std::make_unique<copy>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "COPY")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("COPY",
        std::make_unique<copy>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "COPY")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CSECT",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "CSECT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("CXD",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "CXD")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("DC",
        std::make_unique<dc>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "DC")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("DROP",
        std::make_unique<drop>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "DROP")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("DS",
        std::make_unique<ds_dxd>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "DS")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("DSECT",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "DSECT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("DXD",
        std::make_unique<ds_dxd>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL },
            "DXD")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("EJECT",
        std::make_unique<no_operands>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "EJECT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("END",
        std::make_unique<end>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "END")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ENTRY",
        std::make_unique<entry>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "ENTRY")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("EQU",
        std::make_unique<equ>(std::vector<label_types> { label_types::ORD_SYMBOL, label_types::VAR_SYMBOL }, "EQU")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("EXITCTL",
        std::make_unique<exitctl>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "EXITCTL")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("EXTRN",
    ...
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ISEQ",
        std::make_unique<iseq>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "ISEQ")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("LOCTR",
        std::make_unique<no_operands>(
            std::vector<label_types> { label_types::ORD_SYMBOL, label_types::VAR_SYMBOL }, "LOCTR")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("LTORG",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::ORD_SYMBOL, label_types::VAR_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::OPTIONAL },
            "LTORG")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("MNOTE",
        std::make_unique<mnote>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "MNOTE")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("OPSYN",
        std::make_unique<opsyn>(
            std::vector<label_types> { label_types::ORD_SYMBOL, label_types::VAR_SYMBOL, label_types::OPERATION_CODE },
            "OPSYN")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("ORG",
        std::make_unique<org>(
            std::vector<label_types> {
                label_types::ORD_SYMBOL, label_types::VAR_SYMBOL, label_types::SEQUENCE_SYMBOL, label_types::OPTIONAL },
            "ORG")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("POP",
        std::make_unique<stack_instr>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "POP")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("PRINT",
        std::make_unique<print>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "PRINT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("PUNCH",
        std::make_unique<punch>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "PUNCH")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("PUSH",
        std::make_unique<stack_instr>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "PUSH")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("REPRO",
        std::make_unique<no_operands>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "REPRO")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("RMODE",
        std::make_unique<rmode>(std::vector<label_types> { label_types::OPTIONAL, label_types::NAME }, "RMODE")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("RSECT",
        std::make_unique<no_operands>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::ORD_SYMBOL, label_types::VAR_SYMBOL, label_types::SEQUENCE_SYMBOL },
            "RSECT")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("SPACE",
        std::make_unique<expression_instruction>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "SPACE")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("START",
        std::make_unique<expression_instruction>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL, label_types::ORD_SYMBOL, label_types::VAR_SYMBOL },
            "START")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("TITLE",
        std::make_unique<title>(
            std::vector<label_types> {
                label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL, label_types::VAR_SYMBOL, label_types::STRING },
            "TITLE")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("USING",
        std::make_unique<using_instr>(
            ...
            "USING")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("WXTRN",
        std::make_unique<external>(
            std::vector<label_types> { label_types::OPTIONAL, label_types::SEQUENCE_SYMBOL }, "WXTRN")));
    assembler_instruction_map.insert(std::pair<std::string, std::unique_ptr<assembler_instruction>>("XATTR",
