...
namespace hlasm_plugin::parser_library::expressions {
	...
	public:
		...
		virtual antlrcpp::Any visitId_sub(hlasm_plugin::parser_library::generated::hlasmparser::Id_subContext * ctx) override;
		...
		virtual antlrcpp::Any visitNum(hlasm_plugin::parser_library::generated::hlasmparser::NumContext* ctx) override;
		expression_visitor(context::hlasm_context& hlasm_ctx);
	private:
