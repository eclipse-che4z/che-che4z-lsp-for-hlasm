...
public:
    ...
    static context::SET_t D2A(std::string_view param, ranged_diagnostic_collector add_diagnostic);
    ...
    static context::SET_t ISBIN(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t ISDEC(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t ISHEX(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t ISSYM(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t X2A(std::string_view param, ranged_diagnostic_collector add_diagnostic);
    ...
    static context::SET_t B2C(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t B2D(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t B2X(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t BYTE(context::A_t param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t C2B(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t C2D(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t C2X(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t D2B(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t D2C(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t D2X(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t DCVAL(const context::C_t& param);
    static context::SET_t DEQUOTE(context::C_t param);
    static context::SET_t DOUBLE(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    ...
    static context::SET_t X2B(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
    static context::SET_t X2C(const context::C_t& param, ranged_diagnostic_collector add_diagnostic);
