...
macro_param_base::macro_param_base(macro_param_type param_type, id_index name, bool is_global)
	:variable_symbol(variable_kind::MACRO_VAR_KIND, name, is_global), param_type(param_type) {}
...
keyword_param::keyword_param(id_index name, macro_data_shared_ptr default_value, macro_data_ptr assigned_value)
	: macro_param_base(macro_param_type::KEY_PAR_TYPE, name, false), assigned_data_(std::move(assigned_value)), default_data(std::move(default_value)) {}
...
positional_param::positional_param(id_index name, size_t position, const macro_param_data_component& assigned_value)
	: macro_param_base(macro_param_type::POS_PAR_TYPE, name, false), data_(assigned_value), position(position) {}
