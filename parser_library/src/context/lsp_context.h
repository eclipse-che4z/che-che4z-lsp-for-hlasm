...
#include "../semantics/semantic_objects.h"
...
namespace hlasm_plugin {
	namespace parser_library {
		namespace context {
			...
			{
				definition() = default;
				definition(std::string name, std::string scope, std::string file_name, semantics::symbol_range range, bool check_scopes = true) : name(std::move(name)), scope(std::move(scope)), file_name(std::move(file_name)), range(range), documentation(std::move(documentation)), check_scopes(check_scopes) {}
