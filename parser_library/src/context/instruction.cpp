...
std::map<const std::string, machine_instruction_ptr> hlasm_plugin::parser_library::context::instruction::get_machine_instructions()
{
	...
	result.insert(std::pair <const std::string, machine_instruction_ptr>("UNPK", std::make_unique<machine_instruction>("UNPK", mach_format::SS_b, std::vector<machine_operand_format>{ db_12_4x4L_U, db_12_4x4L_U }, 48, 900)));
