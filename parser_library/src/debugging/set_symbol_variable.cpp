...
set_symbol_variable::set_symbol_variable(const context::set_symbol_base& set_sym, int index)
	: set_symbol_(set_sym), index_(index)
{
...
set_symbol_variable::set_symbol_variable(const context::set_symbol_base& set_sym)
	: set_symbol_(set_sym), index_()
{
	fill_string_value();
}

const std::string& set_symbol_variable::get_string_value() const
{
	return get_value<std::string>();
}


set_type set_symbol_variable::type() const
{
	return (set_type)set_symbol_.type;
}

const std::string& set_symbol_variable::get_string_name() const
{
	return *set_symbol_.id;
}
...
size_t set_symbol_variable::size() const
{
	return set_symbol_.size();
}
