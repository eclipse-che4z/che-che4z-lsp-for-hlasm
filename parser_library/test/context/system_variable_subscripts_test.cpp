...
class sys_var_subscripts_standard_behavior_fixture : public ::testing::TestWithParam<system_variable_params>
{};

} // namespace

INSTANTIATE_TEST_SUITE_P(system_variable_subscripts,
    sys_var_subscripts_standard_behavior_fixture,
...
TEST_P(sys_var_subscripts_standard_behavior_fixture, standard_behavior)
{
