...
B EQU T'W
    ...
    EXPECT_EQ(a.hlasm_ctx().ord_ctx.get_symbol(a.hlasm_ctx().ids().add("A"))->kind(), symbol_value_kind::UNDEF);
    EXPECT_EQ(a.hlasm_ctx().ord_ctx.get_symbol(a.hlasm_ctx().ids().add("B"))->kind(), symbol_value_kind::UNDEF);
