...
inline data_definition_operand setup_data_def_op(char type, char extension, std::variant<std::string, nominal_value_expressions> nominal)
{
	data_definition_operand op = setup_data_def_op(type, extension);
...
inline data_definition_operand setup_data_def_op(char type, char extension, std::variant<std::string, nominal_value_expressions> nominal, int32_t length)
{
...
inline nominal_value_expressions setup_expressions() {
...
template<typename ... values>
inline data_definition_operand setup_data_def_expr_op_length(char type, char extension, int32_t length, const values& ... expr_values_and_types)
{
	nominal_value_expressions op = setup_expressions(expr_values_and_types...);
...
inline nominal_value_expressions setup_addresses() {
	return nominal_value_expressions();
}
