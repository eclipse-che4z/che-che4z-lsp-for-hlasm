...
#ifndef HLASMPLUGIN_HLASMPARSERLIBRARY_DATA_ATTRIBUTE_TEST_H
#define HLASMPLUGIN_HLASMPARSERLIBRARY_DATA_ATTRIBUTE_TEST_H
...
&t6 setc t'&v6
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T1"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "O");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T2"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "N");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T3"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "N");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T4"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "N");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T5"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "N");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T6"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "U");
...
&t1 setc t'&v1
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("T1"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "I");
...
&V5 SETB D'&BAD_SYM
	...
	EXPECT_TRUE(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<B_t>()->get_value());
	EXPECT_TRUE(a.context().get_var_sym(a.context().ids().add("V2"))->access_set_symbol_base()->access_set_symbol<B_t>()->get_value());
	EXPECT_FALSE(a.context().get_var_sym(a.context().ids().add("V3"))->access_set_symbol_base()->access_set_symbol<B_t>()->get_value());
	EXPECT_TRUE(a.context().get_var_sym(a.context().ids().add("V4"))->access_set_symbol_base()->access_set_symbol<B_t>()->get_value());
	EXPECT_FALSE(a.context().get_var_sym(a.context().ids().add("V5"))->access_set_symbol_base()->access_set_symbol<B_t>()->get_value());
...
&V2 SETA L'TEST
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<A_t>()->get_value(),10);
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V2"))->access_set_symbol_base()->access_set_symbol<A_t>()->get_value(),10);
...
&V1 SETA S'A
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<A_t>()->get_value(), 12);
...
EXTEND DC LS10'5.312'
	...
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("HALFCON"))->attributes().integer(), (symbol_attributes::len_attr)9);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("ONECON"))->attributes().integer(), (symbol_attributes::len_attr)23);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("SHORT"))->attributes().integer(), (symbol_attributes::len_attr)4);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("LONG"))->attributes().integer(), (symbol_attributes::len_attr)9);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("EXTEND"))->attributes().integer(), (symbol_attributes::len_attr)18);
...
&V SETA I'HALFCON
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V"))->access_set_symbol_base()->access_set_symbol<A_t>()->get_value(), 9);
...
&V6 SETC O'UNKNOWN
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "O");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V2"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "A");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V3"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "A");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V4"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "E");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V5"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "M");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V6"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "U");
...
&V2 SETC O'&A1
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "O");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V2"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "M");
...
&V3 SETC O'MAC
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "S");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V2"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "U");
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V3"))->access_set_symbol_base()->access_set_symbol<C_t>()->get_value(), "M");
...
B EQU T'W
	...
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("A"))->value().get_abs(), 1);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("B"))->value().get_abs(), symbol_attributes::undef_type);
...
B EQU 1,11
	...
	EXPECT_EQ(a.context().get_var_sym(a.context().ids().add("V1"))->access_set_symbol_base()->access_set_symbol<A_t>()->get_value(), 1);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("A"))->attributes().length(), (symbol_attributes::len_attr)1);
...
B EQU L'A
	...
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("A"))->attributes().length(), (symbol_attributes::len_attr) 11);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("B"))->value().get_abs(), 11);
	EXPECT_EQ(a.context().ord_ctx.get_symbol(a.context().ids().add("B"))->attributes().length(), (symbol_attributes::len_attr)1);
