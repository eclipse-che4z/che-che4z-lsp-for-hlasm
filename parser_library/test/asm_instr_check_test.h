...
public:
	instruction_test(){
		...
		auto process_optable_true_operand = std::make_unique<complex_operand>("OP", std::move(process_optable_true_vector));
		...
		auto process_pcontrol_true_operand = std::make_unique<complex_operand>("PC", std::move(process_pcontrol_true_vector));
		...
		auto process_limit_true_operand = std::make_unique<complex_operand>("LIMIT", std::move(process_limit_true_vector));
		...
		auto process_limit_false_operand = std::make_unique<complex_operand>("LIMIT", std::move(process_limit_false_vector));
		...
		auto process_xref_true_two_operand = std::make_unique<complex_operand>("XREF", std::move(process_xref_true_two_vector));
...
protected:
	...
	one_operand lorem_three = one_operand("'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua'");
