...
INSTANTIATE_TEST_SUITE_P(parameters_suite,
    ...
    ::testing::Values(test_param { ca_expr_funcs::B2A, { "" }, 0, false, "B2A_empty" },
        ...
        test_param { ca_expr_funcs::FIND, { "abcdef", "cde" }, 3, false, "FIND_basic1" },
        ...
        test_param { ca_expr_funcs::A2C, { 0 }, "\0\0\0\0"s, false, "A2C_zero" },
        test_param { ca_expr_funcs::A2C, { 241 }, "\0\0\0"s + "1", false, "A2C_positive" },
        ...
        test_param { ca_expr_funcs::A2X, { 1022 }, "000003FE", false, "A2X_positive" },
        test_param { ca_expr_funcs::A2X, { -7 }, "FFFFFFF9", false, "A2X_negative" },

        test_param { ca_expr_funcs::B2C, { "101110011110001" }, "*1", false, "B2C_valid" },
        test_param { ca_expr_funcs::B2C, { "0" }, "\0"s, false, "B2C_padding" },
        test_param { ca_expr_funcs::B2C, { "00010010001" }, "\0j"s, false, "B2C_padding_zero" },
        ...
        test_param { ca_expr_funcs::B2X, { "0000010010001" }, "0091", false, "B2X_padding" },
        test_param { ca_expr_funcs::B2X, { "" }, "", false, "B2X_empty" },
        test_param { ca_expr_funcs::B2X, { "12" }, {}, true, "B2X_bad_char" },

        test_param { ca_expr_funcs::BYTE, { 0 }, "\0"s, false, "BYTE_zero" },
        test_param { ca_expr_funcs::BYTE, { 97 }, "/", false, "BYTE_valid" },
        test_param { ca_expr_funcs::BYTE, { 2000 }, {}, true, "BYTE_exceeds" },

        test_param { ca_expr_funcs::C2B, { "" }, "", false, "C2B_empty" },
        test_param { ca_expr_funcs::C2B, { "\0"s }, "00000000", false, "C2B_zero" },
        ...
        test_param { ca_expr_funcs::C2D, { "\0"s }, "+0", false, "C2D_zero" },
        test_param { ca_expr_funcs::C2D, { "\0j"s }, "+145", false, "C2D_positive" },
        ...
        test_param { ca_expr_funcs::C2X, { "\0"s }, "00", false, "C2X_zero" },
        ...
        test_param { ca_expr_funcs::D2C, { "000" }, "\0\0\0\0"s, false, "D2C_zeros" },
        test_param { ca_expr_funcs::D2C, { "23793" }, "\0\0*1"s, false, "D2C_basic" },
        ...
        test_param { ca_expr_funcs::LOWER, { "aBcDefG321&^%$" }, "abcdefg321&^%$", false, "LOWER_simple" },
        ...
        test_param { ca_expr_funcs::UPPER, { "aBcDefG321&^%$" }, "ABCDEFG321&^%$", false, "UPPER_simple" },

        test_param { ca_expr_funcs::X2B, { "" }, "", false, "X2B_empty" },
        test_param { ca_expr_funcs::X2B, { "00" }, "00000000", false, "X2B_zeros" },
        test_param { ca_expr_funcs::X2B, { "f3" }, "11110011", false, "X2B_basic" },
        ...
        test_param { ca_expr_funcs::X2C, { "0" }, "\0"s, false, "X2C_zeros" },
        test_param { ca_expr_funcs::X2C, { "F1f2F3F4F5" }, "12345", false, "X2C_basic" },
        test_param { ca_expr_funcs::X2C, { "000F1" }, "\0\0"s + "1", false, "X2C_basic2" },
