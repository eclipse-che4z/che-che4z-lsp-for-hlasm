...
{
    location res = a.context().lsp_ctx->definition(dummy_file_name, { 7, 8 });
...
{
    auto res = a.context().lsp_ctx->references(dummy_file_name, { 7, 8 });
...
{
    auto res = a.context().lsp_ctx->hover(dummy_file_name, { 7, 8 });
...
{
    location res = a.context().lsp_ctx->definition(dummy_file_name, { 3, 11 });
    EXPECT_EQ(res.file, dummy_file_name);
...
{
    auto res = a.context().lsp_ctx->references(dummy_file_name, { 3, 11 });
    ASSERT_EQ(res.size(), 2U);
...
{
    auto res = a.context().lsp_ctx->hover(dummy_file_name, { 3, 11 });
...
{
    location res = a.context().lsp_ctx->definition(dummy_file_name, { 3, 20 });
    EXPECT_EQ(res.file, dummy_file_name);
...
{
    auto res = a.context().lsp_ctx->references(dummy_file_name, { 3, 20 });
    ASSERT_EQ(res.size(), 2U);
...
{
    location res = a.context().lsp_ctx->definition(dummy_file_name, { 3, 1 });
    EXPECT_EQ(res.file, dummy_file_name);
...
{
    auto res = a.context().lsp_ctx->references(dummy_file_name, { 3, 1 });
    ASSERT_EQ(res.size(), 2U);
...
{
    location res = a.context().lsp_ctx->definition(dummy_file_name, { 10, 5 });
    EXPECT_EQ(res.file, dummy_file_name);
...
{
    auto res = a.context().lsp_ctx->references(dummy_file_name, { 10, 5 });
    ASSERT_EQ(res.size(), 2U);
...
{
    auto res = a.context().lsp_ctx->completion(dummy_file_name, { 4, 1 }, '\0', completion_trigger_kind::invoked);
...
{
    auto res = a.context().lsp_ctx->completion(dummy_file_name, { 11, 1 }, '\0', completion_trigger_kind::invoked);
