...
TEST(data_def_operands_length, all_bit_len)
{
	...
	EXPECT_EQ(processing::data_def_postponed_statement<data_instr_type::DC>::get_operands_length(list, ctx.ord_ctx) , 2);
}
...
TEST(data_def_operands_length, byte_in_middle_len)
{
	...
	EXPECT_EQ(processing::data_def_postponed_statement<data_instr_type::DC>::get_operands_length(list, ctx.ord_ctx), 9);
}
...
TEST(data_def_operands_length, explicit_byte)
{
	...
	EXPECT_EQ(processing::data_def_postponed_statement<data_instr_type::DC>::get_operands_length(list, ctx.ord_ctx), 12);
}
...
{
	data_def_type_A t;
	data_definition_operand op = setup_data_def_expr_op('A', '\0', 0, expr_type::RELOC, 0, expr_type::RELOC, 0, expr_type::ABS);
	diag_collector col;
	EXPECT_TRUE(t.check_DC(op, ADD_DIAG(col)));
...
{
	data_def_type_A t;
	data_definition_operand op = setup_data_def_expr_op_length('A', '\0', 3, 0, expr_type::RELOC, 0, expr_type::RELOC, 0, expr_type::ABS);
	diag_collector col;
	EXPECT_TRUE(t.check_DC(op, ADD_DIAG(col)));
...
{
	data_def_type_AD t;
	data_definition_operand op = setup_data_def_expr_op('A', 'D', 0, expr_type::RELOC, 0, expr_type::RELOC, 0, expr_type::ABS);
	diag_collector col;
	EXPECT_TRUE(t.check_DC(op, ADD_DIAG(col)));
...
{
	data_def_type_Y t;
	data_definition_operand op = setup_data_def_expr_op('Y', '\0', 0, expr_type::RELOC, 0, expr_type::RELOC, 0, expr_type::ABS);
	diag_collector col;
	EXPECT_TRUE(t.check_DC(op, ADD_DIAG(col)));
